...
@Component({
  ...
  template: `
    <mgl-map
      [style]="
        'https://api.maptiler.com/maps/streets/style.json?key=8kFttyiouBsoIJZMZXyM'
      "
      [zoom]="[11.15]"
  ...
  `,
  styleUrls: ['./popup-on-click.component.scss'],
})
export class PopupOnClickComponent {
  points: GeoJSON.FeatureCollection<GeoJSON.Point>;
  selectedPoint: any | GeoJSON.Feature | null = null;
  cursorStyle!: string;
